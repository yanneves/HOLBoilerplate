  ...
  <body>
    ...
    <script type="text/javascript">
      ...
      function calibrate() {
        ...
        iterations = Math.min(100000, Math.max(10, iterations))
      }
      ...
      function setup() {
        ...
        r.className = 'result'
        html = '<h2>Benchmark: <i>' + tests[testidx].name + '</i> (' + iterations + ' iterations)</h2><ul>'
        for (var i = 0; i < libs.length; i++) {
      ...
      function win(t, l) {
        document.getElementById('result_' + t + '_' + l).parentNode.className = 'win'
      }
