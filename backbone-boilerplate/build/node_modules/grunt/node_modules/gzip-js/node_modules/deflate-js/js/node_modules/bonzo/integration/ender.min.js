...
/*!
    ...
    * License: MIT
    */
!function(b,c,d){function t(a,b){var d=c.createElement("script"),f=k;d.onload=d.onerror=d[p]=function(){d[n]&&!/^c|loade/.test(d[n])||f||(d.onload=d[p]=null,f=1,i[a]=2,b())},d.async=1,d.src=a,e.insertBefore(d,e.firstChild)}function r(a,b){q(a,function(a){return!b(a)})}var e=c.getElementsByTagName("head")[0],f={},g={},h={},i={},j="string",k=!1,l="push",m="DOMContentLoaded",n="readyState",o="addEventListener",p="onreadystatechange",q=function(a,b){for(var c=0,d=a.length;c<d;++c)if(!b(a[c]))return k;return 1};!c[n]&&c[o]&&(c[o](m,function v(){c.removeEventListener(m,v,k),c[n]="complete"},k),c[n]="loading");var s=function(a,b,c){function o(){if(!--m){f[k]=1,j&&j();for(var a in h)q(a.split("|"),n)&&!r(h[a],n)&&(h[a]=[])}}function n(a){return a.call?a():f[a]}a=a[l]?a:[a];var e=b&&b.call,j=e?b:c,k=e?a.join(""):b,m=a.length;d(function(){r(a,function(a){i[a]?(k&&(g[k]=1),i[a]==2&&o()):(i[a]=1,k&&(g[k]=1),t(s.path?s.path+a+".js":a,o))})},0);return s};s.get=t,s.ready=function(a,b,c){a=a[l]?a:[a];var d=[];!r(a,function(a){f[a]||d[l](a)})&&q(a,function(a){return f[a]})?b():!function(a){h[a]=h[a]||[],h[a][l](b),c&&c(d)}(a.join("|"));return s};var u=b.$script;s.noConflict=function(){b.$script=u;return this},typeof a!="undefined"&&a.exports?a.exports=s:b.$script=s}(this,document,setTimeout),provide("scriptjs",a.exports);var c=require("scriptjs");ender.ender({script:c,ready:c.ready,require:c,getScript:c.get})}(),!function(){var a={exports:{}},b=a.exports;
/*!
