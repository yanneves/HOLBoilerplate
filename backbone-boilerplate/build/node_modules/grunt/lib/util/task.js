...
(function(exports) {
  ...
  Task.prototype.directive = function(value, fn) {
    ...
    if (directive) {
      ...
      return this.helper.apply(this, directive);
    } else if (fn) {
  ...
  Task.prototype._taskPlusArgs = function(name) {
    ...
    return {nameArgs: name, task: task, args: parts.slice(i)};
  };

  // Enqueue a task.
  Task.prototype.run = function() {
    // Parse arguments into an array, returning an array of task+args objects.
    var things = this.parseArgs(arguments).map(this._taskPlusArgs.bind(this));
  ...
  Task.prototype.start = function() {
    ...
    var nextTask = function() {
      ...
      try {
        ...
        var status = thing.task.fn.apply({
